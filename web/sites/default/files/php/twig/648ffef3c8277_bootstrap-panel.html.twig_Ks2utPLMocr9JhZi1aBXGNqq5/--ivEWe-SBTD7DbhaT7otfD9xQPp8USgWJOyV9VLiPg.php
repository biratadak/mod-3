...
class __TwigTemplate_12feb0b7ceb770bffad129bbbb8da236 extends Template
{
    private $source;
    private $macros = [];
...
($context["description"] ?? null) && (twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "position", [], "any", false, false, true, 85) == "invisible"))) ? ("sr-only") : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap/templates/bootstrap/bootstrap-panel.html.twig", "/Users/veer/Documents/projects/Innoraft Interndhip/mod-3/web/themes/contrib/bootstrap/templates/bootstrap/bootstrap-panel.html.twig");
    }
