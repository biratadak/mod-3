...
class __TwigTemplate_33d1ee554b03a1dfd1b409f4b2b16757 extends Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50), 50, $this->source)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/claro/templates/filter/filter-tips.html.twig", "/Users/veer/Documents/projects/Innoraft Interndhip/mod-3/web/core/themes/claro/templates/filter/filter-tips.html.twig");
    }
