...
class __TwigTemplate_6fd9e18eb9ec5e0d170a5aa3bcbd0d78 extends Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap/templates/input/input--button.html.twig", "/Users/veer/Documents/projects/Innoraft Interndhip/mod-3/web/themes/contrib/bootstrap/templates/input/input--button.html.twig");
    }
