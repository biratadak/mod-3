...
class __TwigTemplate_9b8f50fc9d1b0c4e27ea95ad75978fd8 extends Template
{
    private $source;
    private $macros = [];
  ...
  <h2";
        // line 44
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["title_attributes"] ?? null), "setAttribute", [0 => "id", 1 => ($context["heading_id"] ?? null)], "method", false, false, true, 44), 44, $this->source), "html", null, true);
        echo ">";
...
";
  ...
  ";
    ...
    {
        return new Source("", "core/modules/system/templates/block--system-menu-block.html.twig", "/Users/veer/Documents/projects/Innoraft Interndhip/mod-3/web/core/modules/system/templates/block--system-menu-block.html.twig");
    }
